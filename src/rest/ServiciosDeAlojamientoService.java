...
@Path("serviciosDeAlojamiento")
public class ServiciosDeAlojamientoService {
	 ...
	 * @return	<b>Response Status 200</b> - JSON ServicioDeAlojamiento que contiene al servicioDeAlojamiento cuyo ID corresponda al parametro <br/>
	 * 			<b>Response Status 500</b> - Excepcion durante el transcurso de la transaccion
	 */
	@GET
	@Path( "/lookById" )
	@Produces( { MediaType.APPLICATION_JSON } )
	public Response getServicioDeAlojamientoById( @QueryParam( "id1" ) Long id1, @QueryParam( "id2" ) Long id2 )
	{
		try{
			AlohAndesTransactionManager tm = new AlohAndesTransactionManager( getPath( ) );

			ServicioDeAlojamiento servicioDeAlojamiento = tm.getServicioDeAlojamientoByIds( id1, id2 );
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Consumes(MediaType.APPLICATION_JSON)
	public Response updateServicioDeAlojamiento(ServicioDeAlojamiento servicioDeAlojamiento) {
		try{
			AlohAndesTransactionManager tm = new AlohAndesTransactionManager( getPath( ) );
			tm.updateServicioDeAlojamiento(servicioDeAlojamiento);
			return Response.status(200).entity(servicioDeAlojamiento).build();
		}
		catch( Exception e )
		{
