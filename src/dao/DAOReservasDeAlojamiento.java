...
public class DAOReservasDeAlojamiento {
	//----------------------------------------------------------------------------------------------------------------------------------
		...
		public void deleteReservasDeAlojamientoMasiva(Long idReserva) throws SQLException {
			String sql = String.format("DELETE FROM %1$s.RESERVASDEALOJAMIENTO WHERE IDRESERVA = %2$d", USUARIO, idReserva);
